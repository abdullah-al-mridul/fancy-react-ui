...
import DualRingSpinner from "../previewComponents/DualRingSpinner/DualRingSpinner";
import Button from "../previewComponents/Button/Button";

const DualRingSpinnerDemo = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      >
        <DualRingSpinner {...variants[selectedVariant]} />
      </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      root.render(<DualRingSpinnerDemo />);
