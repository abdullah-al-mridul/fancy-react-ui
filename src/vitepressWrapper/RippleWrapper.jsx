...
import RippleSpinner from "../previewComponents/RippleSpinner/RippleSpinner";
import Button from "../previewComponents/Button/Button";

const RippleSpinnerDemo = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      >
        <RippleSpinner {...variants[selectedVariant]} />
      </div>
